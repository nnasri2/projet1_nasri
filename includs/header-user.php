...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../styles/client_dashboard.css">
    <title>ECOM Store : Client Dashboard</title>
                ...
                <?php 
					...
					if (isset($_SESSION['user_id']) ) {?>
                     ...
                     <?php if (isset($_SESSION['role']) == 'user' ){ ?>
                    	<a class="btn btn-success" href="/client/dashboard.php"><i class="fa fa-home"></i> Dashboard</a></a>
                    <?php }?>
