...
<html lang="en">
  <head>
    ...
    <title>ECOM : SUPER DASHBOARD</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="../styles/super_dashboard.css">
  </head>
  <body>
            ...
            <div class="form-inline my-2 my-lg-0">
                ...
                <?php 
					...
					if (isset($_SESSION['user_id']) ) {?>
                        ...
                        <?php if (isset($_SESSION['role']) == 'super' ) {?>
                            <a class="btn btn-success" href="/super/dashboard.php">
                                <i class="fa fa-home"></i> Dashboard</a></a>
                        <?php }?>
